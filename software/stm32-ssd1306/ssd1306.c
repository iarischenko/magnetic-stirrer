...
void ssd1306_WriteCommand(uint8_t byte) {
    ...
    i2c_transfer7(SSD1306_I2C_PORT, SSD1306_I2C_ADDR, buffer, 2, NULL, 0);
}
...
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
    ...
    i2c_transfer7(SSD1306_I2C_PORT, SSD1306_I2C_ADDR, buffer, buff_size, NULL, 0);
}
...
// Screenbuffer
static uint8_t __SSD1306_Buffer[SSD1306_BUFFER_SIZE + 1] = { 0x40 };
static uint8_t *SSD1306_Buffer = &__SSD1306_Buffer[1];
...
/* 
    ...
    */
        ...
        //gpio_set_mode(GPIOB, GPIO_MODE_OUTPUT_2_MHZ, GPIO_CNF_INPUT_FLOAT,
         //             GPIO10);
        //gpio_set_mode(GPIOB, GPIO_MODE_OUTPUT_2_MHZ, GPIO_CNF_INPUT_FLOAT,
         //             GPIO11);
	...
	i2c_set_own_7bit_slave_address(I2C2, 0x0);
	i2c_peripheral_enable(I2C2);
...
void ssd1306_UpdateScreen(void) {
    ...
    //  * 64px   ==  8 pages
    //  * 128px  ==  16 pages
    ssd1306_WriteData(&__SSD1306_Buffer[0], SSD1306_BUFFER_SIZE + 1);
/*
